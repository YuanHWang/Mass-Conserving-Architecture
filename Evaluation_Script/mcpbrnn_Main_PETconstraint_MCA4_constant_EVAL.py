...
weight_file = "results_HYMOD/MCA4-constant/MCPBRNN_Generic_PETconstraint_MCA4_1Layer_1node_10/model_epoch503.pt"
...
CaseName = "results_HYMOD/MCA4-constant/"
...
outname = CaseName + '/' + 'Out_gategw' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)
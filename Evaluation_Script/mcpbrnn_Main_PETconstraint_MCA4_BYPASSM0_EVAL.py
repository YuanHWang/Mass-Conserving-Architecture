...
weight_file = "results_HYMOD/MCA4_BYPASSM0/MCPBRNN_Generic_PETconstraint_MCA4_BYPASSM0_1Layer_1node_1/model_epoch501.pt"
...
# Output time series
    ...
    Out_hidden_SW[0:timeLen,epoch-1] = hidden_eval[:,0] 
...
CaseName = "results_HYMOD/MCA4_BYPASSM0/"
...
outname = CaseName + '/' + 'Out_gate_ogw_' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)

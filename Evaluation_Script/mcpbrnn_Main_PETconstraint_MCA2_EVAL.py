...
Out_rg_gate = np.zeros((timeLen,1))
...
for name, param in model.state_dict().items():
    print(name)
    print(param)
#weight_file = "results_HYMOD/MCA2/MCPBRNN_Generic_PETconstraint_MCA2_1Layer_1node_9/model_epoch86.pt"
...
# Output time series
    ...
    Out_rg_gate [0:timeLen,epoch-1] = rg_gate[:,0]
...
Out_file = pd.DataFrame(Out_rg_gate)
outname = CaseName + '/' + 'Out_gaterg_' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)

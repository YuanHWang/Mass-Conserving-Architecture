...
class Model(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd, SW_mean, SW_std, GW_mean, GW_std, Ini_C):
        ...
        last_h = self.dropout(h_t_MCA3+h_t_MCA4+h_fp_t)      
        out = last_h        
...
weight_file = "results_HYMOD/MA6-BP0/MCPBRNN_Generic_PETconstraint_MCA6_1Layer_1node_6/model_epoch1581.pt"
...
CaseName = 'results_HYMOD/MA6-BP0/'

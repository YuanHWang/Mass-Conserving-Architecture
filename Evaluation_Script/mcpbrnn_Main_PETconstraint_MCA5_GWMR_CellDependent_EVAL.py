...
Out_ov_gate = np.zeros((timeLen,1))
...
class Model(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd, SW_mean, SW_std, GW_mean, GW_std, Ini_C):
        ...
        out = last_h        
        return out, h_t, h_t_MCA3, h_t_MCA4, c_t, c_t_MCA3, c_t_MCA4, l_t, lc_t, gw_t, bp_t, i, oo, oo_MCA3, oo_MCA4, ol, olc, f, f_MCA3, f_MCA4, oogw, ov_MCA4,MRF
...
weight_file = "results_HYMOD/MCA5-GWMR-celldep-Noconstraint/MCPBRNN_Generic_PETconstraint_MCA5_CellDP_NoPARConstraint1Layer_1node_2/model_epoch2000.pt"
...
CaseName = 'results_HYMOD/MCA5-GWMR-celldep-Noconstraint/'

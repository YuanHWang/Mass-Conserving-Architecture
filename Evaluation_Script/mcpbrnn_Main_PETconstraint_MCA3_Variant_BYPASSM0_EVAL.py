...
Out_o_gatesw = np.zeros((timeLen,1))
...
weight_file = "results_HYMOD/MCA3_BYPASSM0/MCPBRNN_Generic_PETconstraint_MCA3_Variant_BYPASSM0_1Layer_1node_10/model_epoch1450.pt"
...
CaseName = "results_HYMOD/MCA3_BYPASSM0/"
...
outname = CaseName + '/' + 'Outhidden_bypass_' + str(cfg["case_no"]) + '_summary.csv'
Out_file.to_csv(outname)
...
Out_file = pd.DataFrame(Out_o_gatesw)

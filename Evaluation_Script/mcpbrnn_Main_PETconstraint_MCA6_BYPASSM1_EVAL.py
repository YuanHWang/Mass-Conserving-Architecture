...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA6_BYPASSM1_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
weight_file = "results_HYMOD/MCA6-BYPASSM1/MCPBRNN_Generic_PETconstraint_MCA6_BYPASSM1_1Layer_1node_10/model_epoch84.pt"
...
CaseName = 'results_HYMOD/MCA6-BYPASSM1/'

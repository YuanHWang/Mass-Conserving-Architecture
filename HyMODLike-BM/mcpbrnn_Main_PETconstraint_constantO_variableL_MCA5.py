...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2, MCPBRNN_SW_Constant_Routing, MCPBRNN_GWConstant_Routing
...
CaseName = 'MCPBRNN_PETconstraint_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA5'
directory = CaseName
...
Ini_dir="CRR-HYMOD-MCA5/MCPBRNN_Generic_M21Layer_1node_1_MCA5/model_epoch1608.pt"
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_constantoutput_variableLoss_MCA2(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval):
        ...
        h_t, c_t, l_t, lc_t, gw_t, bp_t, i, oo, oogw, ol, olc, f, h_nout, obs_std = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval)  
        ...
        out = last_h        
        return out, h_t, h_t_MCA3, h_t_MCA4, c_t, c_t_MCA3, c_t_MCA4, l_t, lc_t, gw_t, bp_t, i, oo, oo_MCA3, oo_MCA4, oogw, ol, olc, f, f_MCA3, f_MCA4
...
for epoch in range(1,num_epochs+1): 
    ...
    lc_gate = Result[17]    
    f_gate = Result[18]
    f_gate_MCA3 = Result[19]
    f_gate_MCA4 = Result[20]

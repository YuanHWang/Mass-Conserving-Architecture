...
CaseName = 'MCPBRNN_Generic_M2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 5 # Temporarily not save the parameter value
skillmetric = 7
...
#weight_file = "/home/u9/yhwang0730/PB-LSTM/2022-Spring/20220329-NewJobs/20220407_Update/Batch_ICGRL_PET_loss_withMC_ANLL_type2-singleANN/old_1500ep/EXP_ICGRL_1_Layer_1node_gatedim_1_1/model_epoch0.pt"

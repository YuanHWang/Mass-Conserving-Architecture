...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2
...
CaseName = 'MCPBRNN_Generic_M2' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA2'
directory = CaseName
...
for epoch in range(1,num_epochs+1): 
    ...
    out_eval = Result[0]
    hidden_eval = Result[0]    
    cell_eval = Result[2]
    loss_eval = Result[3]
    recharge_eval = Result[4]    

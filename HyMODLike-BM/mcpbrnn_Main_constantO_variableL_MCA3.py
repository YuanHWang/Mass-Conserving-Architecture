...
CaseName = 'MCPBRNN_Generic_M2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"]) + '_MCA3'
directory = CaseName
...
par_no = 6 # Temporarily not save the parameter value
skillmetric = 7
...
weight_file = "results_temp/M2-case/MCPBRNN_Generic_M2_1Layer_1node_10/model_epoch468.pt"
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,5]= model.state_dict()["MCPBRNNNode_SW.weight_r_yom"][:]

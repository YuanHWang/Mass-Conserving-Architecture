...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_constantoutput_variableLoss_MCA2, MCPBRNN_SW_Constant_Routing, MCPBRNN_GWConstant_Routing
...
for epoch in range(1,1+1): 
    ...
    Out_recharge[0:timeLen,epoch-1] = lossc_eval[:,0]       

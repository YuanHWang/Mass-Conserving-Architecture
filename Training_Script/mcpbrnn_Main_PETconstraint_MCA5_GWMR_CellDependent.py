...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing, MCPBRNN_GWVariant_Routing_MRRegular_Relaxed
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA5_CellDP_NoPARConstraint' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd, SW_mean, SW_std, GW_mean, GW_std, Ini_C):
        ...
        last_h = self.dropout(h_t_MCA3+h_t_MCA4)      
        out = last_h        
        return out, h_t, h_t_MCA3, h_t_MCA4, c_t, c_t_MCA3, c_t_MCA4, l_t, lc_t, gw_t, bp_t, i, oo, oo_MCA3, oo_MCA4, ol, olc, f, f_MCA3, f_MCA4, oogw, ov_MCA4
...
# Output time series
    ...
    OutMatrix[epoch-1,4]= model.state_dict()["MCPBRNNNode.bias_b0_yom"][:]
    OutMatrix[epoch-1,5]= model.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
    OutMatrix[epoch-1,6]= model.state_dict()["MCPBRNNNode.bias_b0_yom_gw"][:]
    OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.weight_b1_yom_gw"][:]
    OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode.bias_b0_ylm"][:]
    OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode.weight_b2_ylm"][:]
    OutMatrix[epoch-1,10]= model.state_dict()["MCPBRNNNode_SW.weight_r_yom"][:]
    OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode_SW.weight_r_yfm"][:]
    OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode_SW.bias_b0_yom"][:]
    OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode_SW.weight_b1_yom"][:]
    OutMatrix[epoch-1,14]= model.state_dict()["MCPBRNNNode_GW.weight_r_yom"][:]
    OutMatrix[epoch-1,15]= model.state_dict()["MCPBRNNNode_GW.weight_r_yfm"][:]
    OutMatrix[epoch-1,16]= model.state_dict()["MCPBRNNNode_GW.weight_r_yvm"][:]
    OutMatrix[epoch-1,17]= model.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:]        
    OutMatrix[epoch-1,18]= model.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:]
    OutMatrix[epoch-1,19]= model.state_dict()["MCPBRNNNode_GW.bias_b0_yrm"][:]
    OutMatrix[epoch-1,20]= model.state_dict()["MCPBRNNNode_GW.weight_s_yvm"][:]

    print(B2)
    torch.save(model.state_dict(), savetext)


outtofile = pd.DataFrame(OutMatrix, columns=["MCPBRNNNode.weight_r_yom","MCPBRNNNode.weight_r_yom_gw","MCPBRNNNode.weight_r_ylm","MCPBRNNNode.weight_r_yfm","MCPBRNNNode.bias_b0_yom","MCPBRNNNode.weight_b1_yom","MCPBRNNNode.bias_b0_yom_gw","MCPBRNNNode.weight_b1_yom_gw","MCPBRNNNode.bias_b0_ylm","MCPBRNNNode.weight_b2_ylm","MCPBRNNNode_SW.weight_r_yom","MCPBRNNNode_SW.weight_r_yfm","MCPBRNNNode_SW.bias_b0_yom","MCPBRNNNode_SW.weight_b1_yom","MCPBRNNNode_GW.weight_r_yom","MCPBRNNNode_GW.weight_r_yfm","MCPBRNNNode_GW.weight_r_yvm","MCPBRNNNode_GW.bias_b0_yom","MCPBRNNNode_GW.weight_b1_yom","MCPBRNNNode_GW.bias_b0_yrm","MCPBRNNNode_GW.weight_s_yvm",'NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])

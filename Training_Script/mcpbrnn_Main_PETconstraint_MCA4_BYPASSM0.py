...
import csv
# import class
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA4_BYPASSM0_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 15 # Temporarily not save the parameter value
skillmetric = 7
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode_GW.weight_r_yom"][:]
    OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode_GW.weight_r_yfm"][:]

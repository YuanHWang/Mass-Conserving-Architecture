...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate_BYPASSM0, MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing, MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate, MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA6_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 22 # Temporarily not save the parameter value
skillmetric = 7
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.dropout_rate = dropout       
        self.batch_size = batch_size        
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate_BYPASSM0(input_size=input_size_dyn,
                         hidden_size=hidden_size,
                         gate_dim=gate_dim,
                         spinLen=spinLen,
                         traintimeLen=traintimeLen,              
...
weight_file = "MCA6/MCPBRNN_Generic_PETconstraint_MCA6_1Layer_1node_6/model_epoch144.pt"
...
model.state_dict()["MCPBRNNNode.bias_b0_yom_fp"][:] = model_old.state_dict()["MCPBRNNNode.bias_b0_yom_fp"][:]
model.state_dict()["MCPBRNNNode.weight_b1_yom_fp"][:] = model_old.state_dict()["MCPBRNNNode.weight_b1_yom_fp"][:]
...
YHW=np.random.normal(6.5,1,size=(model.state_dict()["MCPBRNNNode.theltaC"][:].shape[0],model.state_dict()["MCPBRNNNode.theltaC"][:].shape[1]))
model.state_dict()["MCPBRNNNode.theltaC"][:]=torch.Tensor(YHW)
...
# Output time series
    ...
    OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode.theltaC"][:]
    
    OutMatrix[epoch-1,14]= model.state_dict()["MCPBRNNNode_SW.weight_r_yom"][:]
    OutMatrix[epoch-1,15]= model.state_dict()["MCPBRNNNode_SW.weight_r_yfm"][:]
    OutMatrix[epoch-1,16]= model.state_dict()["MCPBRNNNode_SW.bias_b0_yom"][:]
    OutMatrix[epoch-1,17]= model.state_dict()["MCPBRNNNode_SW.weight_b1_yom"][:]
    OutMatrix[epoch-1,18]= model.state_dict()["MCPBRNNNode_GW.weight_r_yom"][:]
    OutMatrix[epoch-1,19]= model.state_dict()["MCPBRNNNode_GW.weight_r_yfm"][:]
    OutMatrix[epoch-1,20]= model.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:]
    OutMatrix[epoch-1,21]= model.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:]

    print(B2)
    torch.save(model.state_dict(), savetext)


outtofile = pd.DataFrame(OutMatrix, columns=["MCPBRNNNode.weight_r_yom","MCPBRNNNode.weight_r_yom_gw","MCPBRNNNode.weight_r_yom_fp","MCPBRNNNode.weight_r_ylm","MCPBRNNNode.weight_r_yfm","MCPBRNNNode.bias_b0_yom","MCPBRNNNode.weight_b1_yom","MCPBRNNNode.bias_b0_yom_gw","MCPBRNNNode.weight_b1_yom_gw","MCPBRNNNode.bias_b0_yom_fp","MCPBRNNNode.weight_b1_yom_fp","MCPBRNNNode.bias_b0_ylm","MCPBRNNNode.weight_b2_ylm","MCPBRNNNode.theltaC","MCPBRNNNode_SW.weight_r_yom","MCPBRNNNode_SW.weight_r_yfm","MCPBRNNNode_SW.bias_b0_yom","MCPBRNNNode_SW.weight_b1_yom","MCPBRNNNode_GW.weight_r_yom","MCPBRNNNode_GW.weight_r_yfm","MCPBRNNNode_GW.bias_b0_yom","MCPBRNNNode_GW.weight_b1_yom",'NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])

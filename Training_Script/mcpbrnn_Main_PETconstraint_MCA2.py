...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA2_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 10 # Temporarily not save the parameter value
skillmetric = 7
...
weight_file = "M5-case_Trial1/MCPBRNN_Generic_PETconstraint_Scaling_M5_1Layer_1node_1/model_epoch27.pt"
...
for epoch in range(1,num_epochs+1): 
    ...
    rg_gate = rg_gate.detach().cpu().numpy() 
    #calculate the skill
    ...
    OutMatrix[epoch-1,3]= model.state_dict()["MCPBRNNNode.weight_r_yom_gw"][:]    
    ...
    OutMatrix[epoch-1,6]= model.state_dict()["MCPBRNNNode.bias_b0_ylm"][:]
    OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.weight_b2_ylm"][:]
    OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode.bias_b0_yom_gw"][:]
    OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode.weight_b1_yom_gw"][:]
...
# Save Results file
outtofile = pd.DataFrame(OutMatrix, columns=['MCPBRNNNode.weight_r_yom','MCPBRNNNode.weight_r_ylm','MCPBRNNNode.weight_r_yfm','MCPBRNNNode.weight_r_yom_gw','MCPBRNNNode.bias_b0_yom','MCPBRNNNode.weight_b1_yom','MCPBRNNNode.bias_b0_ylm','MCPBRNNNode.weight_b2_ylm','MCPBRNNNode.bias_b0_yom_gw','MCPBRNNNode.weight_b1_yom_gw','NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])

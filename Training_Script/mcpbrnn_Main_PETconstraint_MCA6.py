...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing,MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate
...
par_no = 21 # Temporarily not save the parameter value
skillmetric = 7
...
class Model_old(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate(input_size=input_size_dyn,
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd, SW_mean, SW_std, GW_mean, GW_std, Ini_C):
        ...
        h_t, c_t, l_t, lc_t, bp_t, gw_t, i, oo, ol, olc, f, oogw, h_nout, obs_std = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval, cmean, cstd)     
        ...
        out = last_h        
        return out, h_t, h_t_MCA3, h_t_MCA4, c_t, c_t_MCA3, c_t_MCA4, l_t, lc_t, gw_t, bp_t, i, oo, oo_MCA3, oo_MCA4, ol, olc, f, f_MCA3, f_MCA4, oogw
...
weight_file = "results_HYMOD/MCA5/MCPBRNN_Generic_PETconstraint_MCA5_1Layer_1node_1/model_epoch619.pt"

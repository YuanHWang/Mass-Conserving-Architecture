...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing, MCPBRNN_GWVariant_Routing_MRRegular
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA5_CellDP_YesPARConstraint' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName

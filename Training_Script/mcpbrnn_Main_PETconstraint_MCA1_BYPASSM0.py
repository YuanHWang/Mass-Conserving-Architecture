...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA1_BYPASSM0_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
YHW=np.random.normal(-5,1,size=(model.state_dict()["MCPBRNNNode.theltaC"][:].shape[0],model.state_dict()["MCPBRNNNode.theltaC"][:].shape[1]))
...
for epoch in range(1,num_epochs+1): 
    ...
    for data in pbar:
        ...
        predictions = model(x,epoch, time_lag, y, c_mean, c_std)[0]      

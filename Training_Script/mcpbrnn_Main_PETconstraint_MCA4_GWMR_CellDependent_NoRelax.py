...
import csv
# import class
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing,MCPBRNN_GWVariant_Routing_MRRegular
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA4_GWMR_CellDP_YesPARConstraint_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName

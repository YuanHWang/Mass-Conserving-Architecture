...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA2_BYPASSM0_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 11 # Temporarily not save the parameter value
skillmetric = 7
...
class Model_old(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd):
        ...
        out = last_h        
        return out, h_t, c_t, l_t, lc_t, gw_t, bp_t, i, oo, ol, olc, f, oogw
...
weight_file = "MCA2/MCPBRNN_Generic_PETconstraint_MCA2_1Layer_1node_10/model_epoch53.pt"
...
#model.state_dict()["MCPBRNNNode.theltaC"][:] = model_old_new.state_dict()["MCPBRNNNode.theltaC"][:]

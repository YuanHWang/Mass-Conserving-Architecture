...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA3_Variant_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode_SW.weight_r_yom"][:]
    OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode_SW.weight_r_yfm"][:]
    OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode_SW.bias_b0_yom"][:]
    OutMatrix[epoch-1,10]= model.state_dict()["MCPBRNNNode_SW.weight_b1_yom"][:]

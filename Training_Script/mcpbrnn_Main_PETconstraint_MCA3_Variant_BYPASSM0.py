...
import csv
# import class
from MCPBRNN_lib_tools.NodeZoo import MCPBRNN_Generic_PETconstraint_Scaling, MCPBRNN_Generic_PETconstraint_Scaling_BYPASSM0
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA3_Variant_BYPASSM0_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 12 # Temporarily not save the parameter value
skillmetric = 7
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.dropout_rate = dropout       
        self.batch_size = batch_size        
        self.MCPBRNNNode = MCPBRNN_Generic_PETconstraint_Scaling_BYPASSM0(input_size=input_size_dyn,
                         hidden_size=hidden_size,
                         gate_dim=gate_dim,
                         spinLen=spinLen,
                         traintimeLen=traintimeLen,              
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,7]= model.state_dict()["MCPBRNNNode.theltaC"][:]        
    OutMatrix[epoch-1,8]= model.state_dict()["MCPBRNNNode_SW.weight_r_yom"][:]
    OutMatrix[epoch-1,9]= model.state_dict()["MCPBRNNNode_SW.weight_r_yfm"][:]
    OutMatrix[epoch-1,10]= model.state_dict()["MCPBRNNNode_SW.bias_b0_yom"][:]
    OutMatrix[epoch-1,11]= model.state_dict()["MCPBRNNNode_SW.weight_b1_yom"][:]

...
import csv
# import class
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA4_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
for epoch in range(1,1+1): 
    ...
    OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:]
    OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:]

    print(B2)
    torch.save(model.state_dict(), savetext)

outtofile = pd.DataFrame(OutMatrix, columns=["MCPBRNNNode.weight_r_yom","MCPBRNNNode.weight_r_yom_gw","MCPBRNNNode.weight_r_ylm","MCPBRNNNode.weight_r_yfm","MCPBRNNNode.bias_b0_yom","MCPBRNNNode.weight_b1_yom","MCPBRNNNode.bias_b0_yom_gw","MCPBRNNNode.weight_b1_yom_gw","MCPBRNNNode.bias_b0_ylm","MCPBRNNNode.weight_b2_ylm","MCPBRNNNode_GW.weight_r_yom","MCPBRNNNode_GW.weight_r_yfm","MCPBRNNNode_GW.bias_b0_yom","MCPBRNNNode_GW.weight_b1_yom",'NSE','KGE','KGE-A','KGE-B','Corr','mse','KGEss','NSE_selection','KGE_selection','KGE-A_selection','KGE-B_selection','Corr_selection','mse_selection','KGEss_selection','NSE_testing','KGE_testing','KGE-A_testing','KGE-B_testing','Corr_testing','mse_testing','KGEss_testing','NSE_spinup','KGE_spinup','KGE-A_spinup','KGE-B_spinup','Corr_spinup','mse_spinup','KGEss_spinup','KGEtimelag_1','KGEtimelag_2','KGEtimelag_3'])

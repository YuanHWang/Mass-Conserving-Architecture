...
import csv
# import class
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate_BYPASSM1
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA4_BYPASSM1_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 16 # Temporarily not save the parameter value
skillmetric = 7
...
weight_file = "MCA4/MCPBRNN_Generic_PETconstraint_MCA4_1Layer_1node_9/model_epoch425.pt"
...
for epoch in range(1,num_epochs+1): 
    ...
    OutMatrix[epoch-1,12]= model.state_dict()["MCPBRNNNode_GW.weight_r_yom"][:]
    OutMatrix[epoch-1,13]= model.state_dict()["MCPBRNNNode_GW.weight_r_yfm"][:]
    OutMatrix[epoch-1,14]= model.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:]
    OutMatrix[epoch-1,15]= model.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:]        

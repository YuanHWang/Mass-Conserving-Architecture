...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_GWVariant_Routing_MRRegular_Relaxed, MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing,MCPBRNN_Generic_PETconstraint_Three_VariantOutputGate
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA6_CellDP_NoPARConstraint_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.MCPBRNNNode_SW = MCPBRNN_SW_Variant_Routing(input_size=input_size_dyn,
                         ...
                         traintimeLen=traintimeLen,              
                         initial_forget_bias=initial_forget_bias)  
        self.MCPBRNNNode_GW = MCPBRNN_GWVariant_Routing_MRRegular_Relaxed(input_size=input_size_dyn,
                         hidden_size=hidden_size,
                         gate_dim=gate_dim,
                         spinLen=spinLen,
                         traintimeLen=traintimeLen,              

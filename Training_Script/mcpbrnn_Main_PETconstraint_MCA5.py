...
from MCPBRNN_lib_tools.HyMODZoo import MCPBRNN_Generic_PETconstraint_Two_VariantOutputGate, MCPBRNN_GWVariant_Routing, MCPBRNN_SW_Variant_Routing
...
CaseName = 'MCPBRNN_Generic_PETconstraint_MCA5_' + str(depth_size) + 'Layer_1node_' + str(cfg["case_no"])
directory = CaseName
...
par_no = 18 # Temporarily not save the parameter value
skillmetric = 7
...
class Model_MCA2(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd):
        ...
        out = last_h        
        return out, h_t, c_t, l_t, lc_t, bp_t, gw_t, i, oo, ol, olc, f, oogw
...
class Model_MCA3(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval,c_mean,c_std,SW_mean,SW_std):

        h_t, c_t, l_t, lc_t, bp_t, i, oo, ol, olc, f, h_nout, obs_std = self.MCPBRNNNode(x_d, epoch, time_lag, y_eval, c_mean,c_std)    
        h_t_sw, c_t_sw, oo_sw, f_sw = self.MCPBRNNNode_SW(h_t, epoch, time_lag, y_eval,SW_mean,SW_std)
        last_h = self.dropout(h_t_sw)      
        out = last_h        
        return out, h_t, c_t_sw, c_t, l_t, lc_t, bp_t, i, oo_sw, oo, ol, olc, f_sw, f
...
class Model_MCA4(nn.Module):
    ...
    def forward(self, x_d, epoch, time_lag, y_eval, cmean, cstd, GW_mean, GW_std, Ini_C):
        ...
        out = last_h        
        return out, h_t, h_t_MCA4, c_t, c_t_MCA4, l_t, lc_t, gw_t, bp_t, i, oo, oo_MCA4, ol, olc, f, f_MCA4, oogw
...
weight_file = "results_HYMOD/MCA2/MCPBRNN_Generic_PETconstraint_MCA2_1Layer_1node_10/model_epoch53.pt"
model_MCA2.load_state_dict(torch.load(weight_file))
weight_file = "results_HYMOD/MCA3/MCPBRNN_Generic_PETconstraint_MCA3_Variant_1Layer_1node_9/model_epoch193.pt"
model_MCA3.load_state_dict(torch.load(weight_file))
weight_file = "results_HYMOD/MCA4/MCPBRNN_Generic_PETconstraint_MCA4_1Layer_1node_9/model_epoch425.pt"
...
model.state_dict()["MCPBRNNNode.bias_b0_yom"][:] = model_MCA2.state_dict()["MCPBRNNNode.bias_b0_yom"][:]
model.state_dict()["MCPBRNNNode.weight_b1_yom"][:] = model_MCA2.state_dict()["MCPBRNNNode.weight_b1_yom"][:]
model.state_dict()["MCPBRNNNode.bias_b0_yom_gw"][:] = model_MCA2.state_dict()["MCPBRNNNode.bias_b0_yom_gw"][:]
model.state_dict()["MCPBRNNNode.weight_b1_yom_gw"][:] = model_MCA2.state_dict()["MCPBRNNNode.weight_b1_yom_gw"][:]
...
model.state_dict()["MCPBRNNNode_SW.weight_r_yfm"][:] = model_MCA3.state_dict()["MCPBRNNNode_SW.weight_r_yfm"][:]
model.state_dict()["MCPBRNNNode_SW.bias_b0_yom"][:] = model_MCA3.state_dict()["MCPBRNNNode_SW.bias_b0_yom"][:]
model.state_dict()["MCPBRNNNode_SW.weight_b1_yom"][:] = model_MCA3.state_dict()["MCPBRNNNode_SW.weight_b1_yom"][:]

model.state_dict()["MCPBRNNNode_GW.weight_r_yom"][:] = model_MCA4.state_dict()["MCPBRNNNode_GW.weight_r_yom"][:]
model.state_dict()["MCPBRNNNode_GW.weight_r_yfm"][:] = model_MCA4.state_dict()["MCPBRNNNode_GW.weight_r_yfm"][:]
model.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:] = model_MCA4.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:]
model.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:] = model_MCA4.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:]
...
# Output time series
    ...
    OutMatrix[epoch-1,16]= model.state_dict()["MCPBRNNNode_GW.bias_b0_yom"][:]
    OutMatrix[epoch-1,17]= model.state_dict()["MCPBRNNNode_GW.weight_b1_yom"][:]
